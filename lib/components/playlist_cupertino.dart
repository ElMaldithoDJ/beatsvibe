...
class PlaylistContextMenu extends StatefulWidget {
  final Widget child;
  final List<PlaylistMenuItem> actions;
  ...
  @override
  State<PlaylistContextMenu> createState() =>
      _PlaylistContextMenuState();
}

class _PlaylistContextMenuState extends State<PlaylistContextMenu>
